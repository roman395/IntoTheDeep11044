...
public class TeleOpBlue extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        while (opModeIsActive())
        {
            ...
            linkage.TeleOp();
            lift.TeleOp();
            if((-g.right_stick_y<=0.1&&-g.right_stick_y>=-0.1)||(linkage.m.getCurrentPosition()>Linkage.maxPromotion
                    ||linkage.m.getCurrentPosition()<Linkage.minPromotion))
            ...
            telemetry.addData("IsDone",linkage.done);
            telemetry.update();
